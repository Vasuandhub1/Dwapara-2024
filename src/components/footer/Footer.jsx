...
function Footer() {
  return (
    <div className="w-full text-white lg:w-100 px-4 lg:px-[80px] py-[90px] flex flex-col justify-center bg-[#043873] font-mono">
      {/* container div */}
      <div className="flex flex-col lg:flex-row lg:justify-evenly lg:items-start text-center lg:text-left">
        {/* main box */}
        <div className="lg:w-[205.25px] h-[169px] space-y-3">
          <h1 className="font-bold text-3xl">Sahapathi</h1>
      ...
      {/* 2nd   main box */}
      <div >
     <ul className="my-10 flex flex-col lg:flex-row justify-center lg:justify-between">
